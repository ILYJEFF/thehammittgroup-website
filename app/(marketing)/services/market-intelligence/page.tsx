...
export const metadata: Metadata = {
  ...
  description: "Data-driven insights on market rates, talent availability, and competitive positioning for Texas manufacturing companies.",
  keywords: ["market intelligence", "salary benchmarking", "compensation analysis", "talent market data"],
  openGraph: {
    title: "Market Intelligence & Salary Benchmarking | The Hammitt Group",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <nav className="mb-8" aria-label="Breadcrumb">
          <ol className="flex items-center space-x-2 text-sm text-gray-600">
            ...
            <li>/</li>
            <li className="text-gray-900 font-medium">Market Intelligence</li>
          </ol>
        </nav>
        <div className="mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
            Data-driven insights on market rates, talent availability, and competitive positioning for Texas manufacturing.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          <div className="lg:col-span-2 space-y-8">
            <section>
              <h2 className="text-3xl font-display font-bold text-gray-900 mb-6">Market Insights</h2>
