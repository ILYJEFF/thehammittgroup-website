...
export const metadata: Metadata = {
  ...
  description: "Smooth transition support to ensure new hires integrate successfully into your manufacturing organization.",
  keywords: ["onboarding", "new hire integration", "employee onboarding", "manufacturing onboarding"],
  openGraph: {
    title: "Onboarding & Integration Support | The Hammitt Group",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
            Smooth transition support to ensure new hires integrate successfully into your manufacturing organization.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          <div className="lg:col-span-2 space-y-8">
            <section>
              <h2 className="text-3xl font-display font-bold text-gray-900 mb-6">Successful Integration</h2>
