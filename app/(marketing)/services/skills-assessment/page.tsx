...
export const metadata: Metadata = {
  ...
  description: "Comprehensive evaluation of technical skills, competencies, and cultural fit for manufacturing candidates.",
  keywords: ["skills assessment", "candidate testing", "technical evaluation", "manufacturing skills"],
  openGraph: {
    title: "Skills Assessment & Testing | The Hammitt Group",
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-12">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
            Comprehensive evaluation of technical skills, competencies, and cultural fit for manufacturing candidates.
          </p>
        </div>
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-16">
          <div className="lg:col-span-2 space-y-8">
            <section>
              <h2 className="text-3xl font-display font-bold text-gray-900 mb-6">Thorough Candidate Evaluation</h2>
              <p className="text-gray-700 text-lg leading-relaxed mb-6">
                Ensure you hire candidates with the right skills and cultural fit through comprehensive assessment and testing tailored to manufacturing roles.
              </p>
            </section>
          </div>
